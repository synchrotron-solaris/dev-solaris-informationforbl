...
This package contains InformationForBeamlines device class based on the facadedevice library. It stores communication between Control Room and beamlines.
"""
